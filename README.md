...
![Screenshot](Screenshot 2026-03-01 191302.png)
...
Reset‑Ready Design
A single click resets the  and clears the interface, allowing you to start fresh without refreshing the page or losing your workflow rhythm.

How It Works

1. Upload a Document
Drag in a PDF, TXT, PNG, JPG, or JPEG. The assistant immediately ingests the file and prepares it for processing. There’s no configuration, no menus, and no setup — the workflow begins the moment the file is added.conversation
